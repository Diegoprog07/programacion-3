...
public class Usuarios {
    ...
    public int guardarUsuario(String Nombre, String Apellido, String Username, String Email, 
                             String Ciudad, String Codigo_postal, String Clave) throws SQLException {
        Conector db = new Conector();
        db.conectar();
        String query = "INSERT INTO usuarios (Nombre, Apellido, Username, Email, Ciudad, Codigo_Postal, clave) "
                     + "VALUES (?, ?, ?, ?, ?, ?, ?)";
        return db.executeUpdate(query, Nombre, Apellido, Username, Email, Ciudad, Codigo_postal, Clave);
    }
    ...
    public int actualizarUsuario(int id, String Nombre, String Apellido, String Username, String Email, 
        ...
        String query = "UPDATE usuarios SET Nombre = ?, Apellido = ?, Username = ?, Email = ?, "
                     + "Ciudad = ?, Codigo_postal = ?, clave = ? WHERE id = ?";
        return db.executeUpdate(query, Nombre, Apellido, Username, Email, Ciudad, Codigo_postal, Clave, id);
    }
